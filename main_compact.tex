...
\usepackage[style=ieee,url=false,doi=false,maxbibnames=99,sorting=none,dashed=false,backend=biber]{biblatex}
...
\begin{itemize}
  ...
  Publications: \cite{Saurabh_IS25, ICASSP25_DID, IS24_ASR, ASRU23_RESPIN}
  \begin{itemize}
